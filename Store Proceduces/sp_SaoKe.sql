...
=======
    SELECT CT.SOTIEN,CT.SOTK_NHAN,CT.NGAYGD FROM LINK2.NGANHANG.dbo.GD_CHUYENTIEN AS CT
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
    ...
    AND NGAYGD >= @dateFrom  
=======
    SELECT CT_Nhan.SOTIEN,CT_Nhan.SOTK_NHAN,CT_Nhan.NGAYGD FROM LINK2.NGANHANG.dbo.GD_CHUYENTIEN AS CT_Nhan
    WHERE SOTK_NHAN =@SOTK_SAOKE
