        ...
        private void btLuu_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int result = Program.ExecSqlAndGetReturnedValue2("sp_TaoLogin",
                                                       new SqlParameter("@LGNAME", txtLoginNameKH.Text),
                                                       new SqlParameter("@PASS", txtPassKH.Text),
                                                       new SqlParameter("@USERNAME", cMNDComboBox.Text),
                                                       new SqlParameter("@ROLE", "KhachHang"));
                if (result == 1) 
                {
